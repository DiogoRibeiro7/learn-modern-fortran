...
Work through them in order. Lessons 01-06 and 09 are fully expanded.
Lessons 07-08 are outlines that will be expanded in future updates.
...
| 06 | [06-testing-with-fpm](06-testing-with-fpm/) | `fpm test`, assertions, tolerances, edge cases, test organization | Complete |
